...
class MainWindow(QWidget):
    ...
    def on_click(self):
        ...
        if (hostname == "" or api_key == "" or ip_loc == "") :
            QMessageBox.about(self, "Error", "Please fill the field")
        else:
            resultserv = self.__query(hostname, api_key, ip_loc)
            if resultserv:
    ...
    def __query(self, hostname, api_key, ip_loc):
